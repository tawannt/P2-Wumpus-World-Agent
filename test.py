...
#             print(len(kb.clauses.conjuncts))
#             # print(kb.clauses.formula())
#             # # for c in kb.clauses.conjuncts[82:]:
#             # #     print(c.formula())
...
def main_interactive():
    ...
    print(f"\nGame ended after {step} steps.")
    print(f"Agent performance: {agent.performance}")
    print(f"Outcome: {'Success with gold' if env.gold_taken else 'Died' if not agent.alive else 'Escaped without gold'}")
