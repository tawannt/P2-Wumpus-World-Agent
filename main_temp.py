...
def main():
    ...
    kb = KnowledgeBase(N=2)
    kb.clauses.add(Symbol('Breeze_1_1'))
    kb.clauses.add(Not(Symbol('Stench_1_1')))
    ...
    print(kb.ask(Symbol('Pit_1_2')))  # Should be False
    # kb.clauses.add(Not(Symbol('Pit_1_2')))
    # kb.clauses.add(Not(Symbol('Breeze_1_3')))
    kb.clauses.add(Symbol('Breeze_2_2'))
    kb.clauses.add(Not(Symbol('Stench_2_2')))
    print()
    print()
    # print()
    # print()
    # print(kb.clauses.formula()) 
    print(kb.ask(Symbol('Pit_1_2')))  # Should be True    
